...
! function (a) {
    var b = "0.9.3",
        ...
        i = function () {
            ...
            return c.mixin(d.prototype, {
                ...
                _mergeProcessedData: function (a) {
                    var b = this;
                    if (c.mixin(this.itemHash, a.itemHash), c.each(a.adjacencyList, function (a, c) {
                        var d = b.adjacencyList[a];
                        b.adjacencyList[a] = d ? d.concat(c) : c
                    }), 0 === this.minLength) {
                        for (var d in a.itemHash) this.defaultOrder.push(d);
                        c.isFunction(this.defaultSort) && this.defaultOrder.sort(function (a, c) {
                            return b.defaultSort(b.itemHash[a], b.itemHash[c])
                        })
                    }
                },
                _getDefaultList: function () {
                    for (var a = [], b = 0; b < Math.min(this.limit, this.defaultOrder.length); b++) a.push(this.itemHash[this.defaultOrder[b]]);
                    return a
                },
                ...
                getSuggestions: function (a, b) {
                    ...
                    if (!(a.length < this.minLength)) {
                        if (0 == a.length) return b(this._getDefaultList());
                        e = c.tokenizeQuery(a), f = this._getLocalSuggestions(e).slice(0, this.limit), f.length < this.limit && this.transport && (h = this.transport.get(a, d)), !h && b && b(f)
                    }
                }
            }), d
        }(),
        ...
        k = function () {
            function b(b) {
                c.bindAll(this), this.isOpen = !1, this.isEmpty = !0, this.isMouseOverDropdown = !1, this.showDefaultSuggestions = b.showDefaultSuggestions, this.$menu = a(b.menu).on("mouseenter.tt", this._handleMouseenter).on("mouseleave.tt", this._handleMouseleave).on("click.tt", ".tt-suggestion", this._handleSelection).on("mouseover.tt", ".tt-suggestion", this._handleMouseover)
            }
            ...
            return c.mixin(b.prototype, d, {
                ...
                open: function () {
                    this.isOpen || (this.isOpen = !0, (this.showDefaultSuggestions || !this.isEmpty) && this._show(), this.trigger("opened"))
                },
        ...
        l = function () {
            function b(a) {
                var b, d, f;
                c.bindAll(this), this.$node = e(a.input), this.datasets = a.datasets, this.dir = null, this.showDefaultSuggestions = !1, this.eventBus = a.eventBus, b = this.$node.find(".tt-dropdown-menu"), d = this.$node.find(".tt-query"), f = this.$node.find(".tt-hint");
                for (var g = 0; g < this.datasets.length; g++) 0 === this.datasets[g].minLength && (this.showDefaultSuggestions = !0);
            ...
            return c.isMsie() && c.mixin(h.query, {
                ...
                _updateHint: function () {
                    ...
                    if (h && i && !j) {
                        if (a = this.inputView.getInputValue(), !a) return;
                        b = a.replace(/\s{2,}/g, " ").replace(/^\s+/g, ""), d = c.escapeRegExChars(b), e = new RegExp("^(?:" + d + ")(.*$)", "i"), f = e.exec(h), this.inputView.setHintValue(a + (f ? f[1] : ""))
                    }
                },
                _clearHint: function () {
                ...
                _handleFocus: function () {
                    this.showDefaultSuggestions && this._getSuggestions(), this._openDropdown()
                },
                ...
                _getSuggestions: function () {
                    ...
                    (!c.isBlankString(b) || this.showDefaultSuggestions) && c.each(this.datasets, function (c, d) {
