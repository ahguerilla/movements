...
def string_constants(context):
    string_constants = json.dumps(
        {
            'exchange': _('Exchange'),
            'exchangivists': _('Exchangivists'),
            'more': _('more...'),
            'view_recommendation': _('Click here to view the recommendation'),
            'offering': _('Offering'),
            'requesting': _('Requesting'),
            'user_search_by_params': _('Search by keyword or username for Exchangivists'),
            ...
            'redirect_off_site': _('This link will take you off the Exchangivist site.\nMake sure you trust the site that you are being redirected to.'),
        })
