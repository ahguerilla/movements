...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserRate'
        db.create_table(u'users_userrate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='rates', null=True, to=orm['auth.User'])),
            ('pub_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('score', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'users', ['UserRate'])

        # Adding field 'UserProfile.ratecount'
        db.add_column(u'users_userprofile', 'ratecount',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'UserRate'
        db.delete_table(u'users_userrate')

        # Deleting field 'UserProfile.ratecount'
        db.delete_column(u'users_userprofile', 'ratecount')
