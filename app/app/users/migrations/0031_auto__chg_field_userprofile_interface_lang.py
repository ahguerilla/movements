...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.interface_lang'
        db.alter_column(u'users_userprofile', 'interface_lang', self.gf('django.db.models.fields.CharField')(max_length=6))

    def backwards(self, orm):

        # Changing field 'UserProfile.interface_lang'
        db.alter_column(u'users_userprofile', 'interface_lang', self.gf('django.db.models.fields.CharField')(max_length=3))
