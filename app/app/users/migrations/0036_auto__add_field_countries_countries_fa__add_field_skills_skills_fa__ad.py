...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Countries.countries_fa'
        db.add_column(u'users_countries', 'countries_fa',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Skills.skills_fa'
        db.add_column(u'users_skills', 'skills_fa',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Language.name_fa'
        db.add_column(u'users_language', 'name_fa',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Interest.name_fa'
        db.add_column(u'users_interest', 'name_fa',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Residence.residence_fa'
        db.add_column(u'users_residence', 'residence_fa',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Issues.issues_fa'
        db.add_column(u'users_issues', 'issues_fa',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Nationality.nationality_fa'
        db.add_column(u'users_nationality', 'nationality_fa',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Region.name_fa'
        db.add_column(u'users_region', 'name_fa',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Countries.countries_fa'
        db.delete_column(u'users_countries', 'countries_fa')

        # Deleting field 'Skills.skills_fa'
        db.delete_column(u'users_skills', 'skills_fa')

        # Deleting field 'Language.name_fa'
        db.delete_column(u'users_language', 'name_fa')

        # Deleting field 'Interest.name_fa'
        db.delete_column(u'users_interest', 'name_fa')

        # Deleting field 'Residence.residence_fa'
        db.delete_column(u'users_residence', 'residence_fa')

        # Deleting field 'Issues.issues_fa'
        db.delete_column(u'users_issues', 'issues_fa')

        # Deleting field 'Nationality.nationality_fa'
        db.delete_column(u'users_nationality', 'nationality_fa')

        # Deleting field 'Region.name_fa'
        db.delete_column(u'users_region', 'name_fa')
