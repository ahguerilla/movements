...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.unsubscribe_uuid'
        db.add_column(u'users_userprofile', 'unsubscribe_uuid',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.unsubscribe_uuid'
        db.delete_column(u'users_userprofile', 'unsubscribe_uuid')
