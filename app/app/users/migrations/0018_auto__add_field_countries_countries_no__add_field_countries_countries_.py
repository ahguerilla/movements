...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Countries.countries_en'
        db.add_column(u'users_countries', 'countries_en',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'Skills.skills_en'
        db.add_column(u'users_skills', 'skills_en',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'Issues.issues_en'
        db.add_column(u'users_issues', 'issues_en',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)
        ...
        db.add_column(u'users_nationality', 'nationality_en',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Countries.countries_en'
        db.delete_column(u'users_countries', 'countries_en')

        # Deleting field 'Skills.skills_no'
        db.delete_column(u'users_skills', 'skills_no')

        # Deleting field 'Skills.skills_en'
        db.delete_column(u'users_skills', 'skills_en')

        # Deleting field 'Issues.issues_no'
        db.delete_column(u'users_issues', 'issues_no')

        # Deleting field 'Issues.issues_en'
        db.delete_column(u'users_issues', 'issues_en')
        ...
        db.delete_column(u'users_nationality', 'nationality_en')
    ...
    models = {
        ...
        u'users.countries': {
            ...
            'countries_no': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'users.issues': {
            ...
            'issues_no': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'})
        },
        u'users.nationality': {
            ...
            'nationality_no': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'})
        },
        ...
        u'users.skills': {
            ...
            'skills_no': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'})
        },
        u'users.userprofile': {
