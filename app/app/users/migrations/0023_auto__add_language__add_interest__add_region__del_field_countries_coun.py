...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'users_userprofile', 'first_login',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding M2M table for field languages on 'UserProfile'
        m2m_table_name = db.shorten_name(u'users_userprofile_languages')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm[u'users.userprofile'], null=False)),
            ('language', models.ForeignKey(orm[u'users.language'], null=False))
        ))
        db.create_unique(m2m_table_name, ['userprofile_id', 'language_id'])

        # Adding M2M table for field regions on 'UserProfile'
        m2m_table_name = db.shorten_name(u'users_userprofile_regions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm[u'users.userprofile'], null=False)),
            ('region', models.ForeignKey(orm[u'users.region'], null=False))
        ))
        db.create_unique(m2m_table_name, ['userprofile_id', 'region_id'])

        # Adding M2M table for field interests on 'UserProfile'
        m2m_table_name = db.shorten_name(u'users_userprofile_interests')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm[u'users.userprofile'], null=False)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'users_language')
        ...
        db.delete_column(u'users_userprofile', 'first_login')

        # Removing M2M table for field languages on 'UserProfile'
        db.delete_table(db.shorten_name(u'users_userprofile_languages'))

        # Removing M2M table for field regions on 'UserProfile'
        db.delete_table(db.shorten_name(u'users_userprofile_regions'))

        # Removing M2M table for field interests on 'UserProfile'
        db.delete_table(db.shorten_name(u'users_userprofile_interests'))
