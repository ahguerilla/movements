...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field translation_languages on 'UserProfile'
        m2m_table_name = db.shorten_name(u'users_userprofile_translation_languages')
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field translation_languages on 'UserProfile'
        db.delete_table(db.shorten_name(u'users_userprofile_translation_languages'))
