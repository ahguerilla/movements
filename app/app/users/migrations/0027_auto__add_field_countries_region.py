...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'users_countries', 'region',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Region'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Countries.region'
        db.delete_column(u'users_countries', 'region_id')
