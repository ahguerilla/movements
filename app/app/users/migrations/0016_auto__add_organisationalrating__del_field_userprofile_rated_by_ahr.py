...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OrganisationalRating'
        db.create_table(u'users_organisationalrating', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('rated_by_ahr', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'users', ['OrganisationalRating'])

        # Deleting field 'UserProfile.rated_by_ahr'
        db.delete_column(u'users_userprofile', 'rated_by_ahr')


    def backwards(self, orm):
        # Deleting model 'OrganisationalRating'
        db.delete_table(u'users_organisationalrating')

        # Adding field 'UserProfile.rated_by_ahr'
        db.add_column(u'users_userprofile', 'rated_by_ahr',
