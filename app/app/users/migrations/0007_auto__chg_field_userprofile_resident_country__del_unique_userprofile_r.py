...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'users_userprofile', 'resident_country_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Residence'], null=True))

        # Changing field 'UserProfile.nationality'
        db.alter_column(u'users_userprofile', 'nationality_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Nationality'], null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.resident_country'
        db.alter_column(u'users_userprofile', 'resident_country_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['users.Residence'], unique=True, null=True))
