...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Language.launguage_code'
        db.add_column(u'users_language', 'launguage_code',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Language.launguage_code'
        db.delete_column(u'users_language', 'launguage_code')
