...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Countries.countries_uk_ua'
        db.delete_column(u'users_countries', 'countries_uk_ua')

        # Adding field 'Countries.countries_uk'
        db.add_column(u'users_countries', 'countries_uk',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Skills.skills_uk_ua'
        db.delete_column(u'users_skills', 'skills_uk_ua')

        # Adding field 'Skills.skills_uk'
        db.add_column(u'users_skills', 'skills_uk',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Language.name_uk_ua'
        db.delete_column(u'users_language', 'name_uk_ua')

        # Adding field 'Language.name_uk'
        db.add_column(u'users_language', 'name_uk',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Interest.name_uk_ua'
        db.delete_column(u'users_interest', 'name_uk_ua')

        # Adding field 'Interest.name_uk'
        db.add_column(u'users_interest', 'name_uk',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Residence.residence_uk_ua'
        db.delete_column(u'users_residence', 'residence_uk_ua')

        # Adding field 'Residence.residence_uk'
        db.add_column(u'users_residence', 'residence_uk',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Issues.issues_uk_ua'
        db.delete_column(u'users_issues', 'issues_uk_ua')

        # Adding field 'Issues.issues_uk'
        db.add_column(u'users_issues', 'issues_uk',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Nationality.nationality_uk_ua'
        db.delete_column(u'users_nationality', 'nationality_uk_ua')

        # Adding field 'Nationality.nationality_uk'
        db.add_column(u'users_nationality', 'nationality_uk',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Region.name_uk_ua'
        db.delete_column(u'users_region', 'name_uk_ua')

        # Adding field 'Region.name_uk'
        db.add_column(u'users_region', 'name_uk',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Countries.countries_uk_ua'
        db.add_column(u'users_countries', 'countries_uk_ua',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Countries.countries_uk'
        db.delete_column(u'users_countries', 'countries_uk')

        # Adding field 'Skills.skills_uk_ua'
        db.add_column(u'users_skills', 'skills_uk_ua',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Skills.skills_uk'
        db.delete_column(u'users_skills', 'skills_uk')

        # Adding field 'Language.name_uk_ua'
        db.add_column(u'users_language', 'name_uk_ua',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Language.name_uk'
        db.delete_column(u'users_language', 'name_uk')

        # Adding field 'Interest.name_uk_ua'
        db.add_column(u'users_interest', 'name_uk_ua',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Interest.name_uk'
        db.delete_column(u'users_interest', 'name_uk')

        # Adding field 'Residence.residence_uk_ua'
        db.add_column(u'users_residence', 'residence_uk_ua',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Residence.residence_uk'
        db.delete_column(u'users_residence', 'residence_uk')

        # Adding field 'Issues.issues_uk_ua'
        db.add_column(u'users_issues', 'issues_uk_ua',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Issues.issues_uk'
        db.delete_column(u'users_issues', 'issues_uk')

        # Adding field 'Nationality.nationality_uk_ua'
        db.add_column(u'users_nationality', 'nationality_uk_ua',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Nationality.nationality_uk'
        db.delete_column(u'users_nationality', 'nationality_uk')

        # Adding field 'Region.name_uk_ua'
        db.add_column(u'users_region', 'name_uk_ua',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Region.name_uk'
        db.delete_column(u'users_region', 'name_uk')
