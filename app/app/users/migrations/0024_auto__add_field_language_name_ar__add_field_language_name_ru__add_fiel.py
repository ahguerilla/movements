...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Language.name_ar'
        db.add_column(u'users_language', 'name_ar',
        ...
        db.add_column(u'users_language', 'name_en',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Interest.name_ar'
        db.add_column(u'users_interest', 'name_ar',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'Interest.name_en'
        db.add_column(u'users_interest', 'name_en',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Region.name_ar'
        db.add_column(u'users_region', 'name_ar',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)
        ...
        db.add_column(u'users_region', 'name_en',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Language.name_ar'
        db.delete_column(u'users_language', 'name_ar')

        # Deleting field 'Language.name_ru'
        db.delete_column(u'users_language', 'name_ru')

        # Deleting field 'Language.name_en'
        db.delete_column(u'users_language', 'name_en')

        # Deleting field 'Interest.name_ar'
        db.delete_column(u'users_interest', 'name_ar')

        # Deleting field 'Interest.name_ru'
        db.delete_column(u'users_interest', 'name_ru')

        # Deleting field 'Interest.name_en'
        db.delete_column(u'users_interest', 'name_en')

        # Deleting field 'Region.name_ar'
        db.delete_column(u'users_region', 'name_ar')

        # Deleting field 'Region.name_ru'
        db.delete_column(u'users_region', 'name_ru')

        # Deleting field 'Region.name_en'
        db.delete_column(u'users_region', 'name_en')
