...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.interface_lang'
        db.add_column(u'users_userprofile', 'interface_lang',
                      self.gf('django.db.models.fields.CharField')(default='en', max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.interface_lang'
        db.delete_column(u'users_userprofile', 'interface_lang')
    ...
    models = {
        ...
        u'users.residence': {
            ...
            'residence_no': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'})
        },
        u'users.skills': {
