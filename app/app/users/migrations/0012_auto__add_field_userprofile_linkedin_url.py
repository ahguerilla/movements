...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.linkedin_url'
        db.add_column(u'users_userprofile', 'linkedin_url',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.linkedin_url'
        db.delete_column(u'users_userprofile', 'linkedin_url')
