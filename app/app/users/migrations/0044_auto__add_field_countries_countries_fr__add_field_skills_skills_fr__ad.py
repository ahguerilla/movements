...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Countries.countries_fr'
        db.add_column(u'users_countries', 'countries_fr',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Skills.skills_fr'
        db.add_column(u'users_skills', 'skills_fr',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Language.name_fr'
        db.add_column(u'users_language', 'name_fr',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Interest.name_fr'
        db.add_column(u'users_interest', 'name_fr',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Residence.residence_fr'
        db.add_column(u'users_residence', 'residence_fr',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Issues.issues_fr'
        db.add_column(u'users_issues', 'issues_fr',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Nationality.nationality_fr'
        db.add_column(u'users_nationality', 'nationality_fr',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Region.name_fr'
        db.add_column(u'users_region', 'name_fr',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Countries.countries_fr'
        db.delete_column(u'users_countries', 'countries_fr')

        # Deleting field 'Skills.skills_fr'
        db.delete_column(u'users_skills', 'skills_fr')

        # Deleting field 'Language.name_fr'
        db.delete_column(u'users_language', 'name_fr')

        # Deleting field 'Interest.name_fr'
        db.delete_column(u'users_interest', 'name_fr')

        # Deleting field 'Residence.residence_fr'
        db.delete_column(u'users_residence', 'residence_fr')

        # Deleting field 'Issues.issues_fr'
        db.delete_column(u'users_issues', 'issues_fr')

        # Deleting field 'Nationality.nationality_fr'
        db.delete_column(u'users_nationality', 'nationality_fr')

        # Deleting field 'Region.name_fr'
        db.delete_column(u'users_region', 'name_fr')
