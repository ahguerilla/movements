...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.vetted_by_ahr'
        db.add_column(u'users_userprofile', 'vetted_by_ahr',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.vetted_by_ahr'
        db.delete_column(u'users_userprofile', 'vetted_by_ahr')
    ...
    models = {
        ...
        u'users.userprofile': {
            ...
            'notperm': ('json_field.fields.JSONField', [], {'default': "u'null'"}),
            ...
            'vetted_by_ahr': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
