...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.tag_ling'
        db.add_column(u'users_userprofile', 'tag_ling',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.tag_ling'
        db.delete_column(u'users_userprofile', 'tag_ling')
