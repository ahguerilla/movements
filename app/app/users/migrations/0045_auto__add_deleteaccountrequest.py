...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DeleteAccountRequest'
        db.create_table(u'users_deleteaccountrequest', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('date_of_request', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'users', ['DeleteAccountRequest'])


    def backwards(self, orm):
        # Deleting model 'DeleteAccountRequest'
        db.delete_table(u'users_deleteaccountrequest')
