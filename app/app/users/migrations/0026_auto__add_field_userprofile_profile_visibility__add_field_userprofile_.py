...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.profile_visibility'
        db.add_column(u'users_userprofile', 'profile_visibility',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1),
                      keep_default=False)

        # Adding field 'UserProfile.notification_frequency'
        db.add_column(u'users_userprofile', 'notification_frequency',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.profile_visibility'
        db.delete_column(u'users_userprofile', 'profile_visibility')

        # Deleting field 'UserProfile.notification_frequency'
        db.delete_column(u'users_userprofile', 'notification_frequency')
