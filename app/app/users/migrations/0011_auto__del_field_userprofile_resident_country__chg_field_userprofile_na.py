...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'UserProfile.nationality' to match new field type.
        db.rename_column(u'users_userprofile', 'nationality', 'nationality_id')
        ...
        # Adding index on 'UserProfile', fields ['nationality']
        db.create_index(u'users_userprofile', ['nationality_id'])


    def backwards(self, orm):
        # Removing index on 'UserProfile', fields ['nationality']
        db.delete_index(u'users_userprofile', ['nationality_id'])

        # Adding field 'UserProfile.resident_country'
        db.add_column(u'users_userprofile', 'resident_country',
                      self.gf('django.db.models.fields.CharField')(default='AFG', max_length=3),
                      keep_default=False)


        # Renaming column for 'UserProfile.nationality' to match new field type.
        db.rename_column(u'users_userprofile', 'nationality_id', 'nationality')
        # Changing field 'UserProfile.nationality'
        db.alter_column(u'users_userprofile', 'nationality', self.gf('django.db.models.fields.CharField')(max_length=3))
