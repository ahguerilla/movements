...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.score'
        db.alter_column(u'users_userprofile', 'score', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):

        # Changing field 'UserProfile.score'
        db.alter_column(u'users_userprofile', 'score', self.gf('django.db.models.fields.IntegerField')())
