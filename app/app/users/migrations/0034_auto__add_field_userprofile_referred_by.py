...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.referred_by'
        db.add_column(u'users_userprofile', 'referred_by',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.referred_by'
        db.delete_column(u'users_userprofile', 'referred_by')
