...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProfile.group_notification_settings'
        db.delete_column(u'users_userprofile', 'group_notification_settings')

        # Deleting field 'UserProfile.privacy_settings'
        db.delete_column(u'users_userprofile', 'privacy_settings')

        # Adding field 'UserProfile.group_notification_preference'
        db.add_column(u'users_userprofile', 'group_notification_preference',
                      self.gf('django.db.models.fields.TextField')(default='{}'),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserProfile.group_notification_settings'
        db.add_column(u'users_userprofile', 'group_notification_settings',
        ...
        # Deleting field 'UserProfile.group_notification_preference'
        db.delete_column(u'users_userprofile', 'group_notification_preference')
    ...
    models = {
        ...
        u'users.userprofile': {
            ...
            'group_notification_preference': ('django.db.models.fields.TextField', [], {'default': "'{}'"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
