...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Residence.residence_en'
        db.add_column(u'users_residence', 'residence_en',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Residence.residence_en'
        db.delete_column(u'users_residence', 'residence_en')
