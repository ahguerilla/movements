...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.user_preference_type'
        db.add_column(u'users_userprofile', 'user_preference_type',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.user_preference_type'
        db.delete_column(u'users_userprofile', 'user_preference_type')
