...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'app_homepagebanner', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('main_image', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ('title_text', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('sub_text', self.gf('django.db.models.fields.CharField')(max_length=300)),
            ('enabled', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('order', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
        ))
        db.send_create_signal(u'app', ['HomePageBanner'])


    def backwards(self, orm):
        # Deleting model 'HomePageBanner'
        db.delete_table(u'app_homepagebanner')
