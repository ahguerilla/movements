...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'NotificationPing'
        db.create_table(u'app_notificationping', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('completed', self.gf('django.db.models.fields.DateTimeField')(null=True)),
        ))
        db.send_create_signal(u'app', ['NotificationPing'])


    def backwards(self, orm):
        # Deleting model 'NotificationPing'
        db.delete_table(u'app_notificationping')
