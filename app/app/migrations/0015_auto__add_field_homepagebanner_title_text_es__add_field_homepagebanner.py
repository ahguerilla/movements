...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HomePageBanner.title_text_es'
        db.add_column(u'app_homepagebanner', 'title_text_es',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'HomePageBanner.sub_text_es'
        db.add_column(u'app_homepagebanner', 'sub_text_es',
                      self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HomePageBanner.title_text_es'
        db.delete_column(u'app_homepagebanner', 'title_text_es')

        # Deleting field 'HomePageBanner.sub_text_es'
        db.delete_column(u'app_homepagebanner', 'sub_text_es')
