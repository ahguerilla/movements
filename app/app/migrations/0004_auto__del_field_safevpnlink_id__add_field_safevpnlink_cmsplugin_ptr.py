...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SafeVPNLink.id'
        db.delete_column(u'app_safevpnlink', u'id')

        # Adding field 'SafeVPNLink.cmsplugin_ptr'
        db.add_column(u'app_safevpnlink', u'cmsplugin_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=0, to=orm['cms.CMSPlugin'], unique=True, primary_key=True),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'SafeVPNLink.id'
        raise RuntimeError("Cannot reverse this migration. 'SafeVPNLink.id' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'SafeVPNLink.id'
        db.add_column(u'app_safevpnlink', u'id',
                      self.gf('django.db.models.fields.AutoField')(primary_key=True),
                      keep_default=False)

        # Deleting field 'SafeVPNLink.cmsplugin_ptr'
        db.delete_column(u'app_safevpnlink', u'cmsplugin_ptr_id')
