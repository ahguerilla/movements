...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MenuExtension'
        db.create_table(u'app_menuextension', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('public_extension', self.gf('django.db.models.fields.related.OneToOneField')(related_name='draft_extension', unique=True, null=True, to=orm['app.MenuExtension'])),
            ('extended_object', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.Page'], unique=True)),
            ('show_on_top_menu', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('show_on_footer_menu', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'app', ['MenuExtension'])


    def backwards(self, orm):
        # Deleting model 'MenuExtension'
        db.delete_table(u'app_menuextension')
