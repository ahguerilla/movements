...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'NewsletterSignups'
        db.create_table(u'app_newslettersignups', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('registered_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('email', self.gf('django.db.models.fields.CharField')(max_length=300)),
        ))
        db.send_create_signal(u'app', ['NewsletterSignups'])


    def backwards(self, orm):
        # Deleting model 'NewsletterSignups'
        db.delete_table(u'app_newslettersignups')
