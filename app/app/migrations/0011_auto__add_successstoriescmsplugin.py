...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SuccessStoriesCMSPlugin'
        db.create_table(u'app_successstoriescmsplugin', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=20)),
        ))
        db.send_create_signal(u'app', ['SuccessStoriesCMSPlugin'])


    def backwards(self, orm):
        # Deleting model 'SuccessStoriesCMSPlugin'
        db.delete_table(u'app_successstoriescmsplugin')
