...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NotificationPing.send_email_to'
        db.add_column(u'app_notificationping', 'send_email_to',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=75),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NotificationPing.send_email_to'
        db.delete_column(u'app_notificationping', 'send_email_to')
