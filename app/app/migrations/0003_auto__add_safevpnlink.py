...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SafeVPNLink'
        db.create_table(u'app_safevpnlink', (
        ...
        db.send_create_signal(u'app', ['SafeVPNLink'])


    def backwards(self, orm):
        # Deleting model 'SafeVPNLink'
        db.delete_table(u'app_safevpnlink')
