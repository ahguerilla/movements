...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MarketItemSalesforceRecord'
        db.create_table(u'market_marketitemsalesforcerecord', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('item', self.gf('django.db.models.fields.related.OneToOneField')(related_name='salesforce', unique=True, to=orm['market.MarketItem'])),
            ('salesforce_record_id', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('last_updated', self.gf('django.db.models.fields.DateTimeField')()),
            ('needs_updating', self.gf('django.db.models.fields.BooleanField')()),
        ))
        db.send_create_signal('market', ['MarketItemSalesforceRecord'])


    def backwards(self, orm):
        # Deleting model 'MarketItemSalesforceRecord'
        db.delete_table(u'market_marketitemsalesforcerecord')
