...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Comment.contents'
        db.alter_column(u'market_comment', 'contents', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Comment.contents'
        db.alter_column(u'market_comment', 'contents', self.gf('tinymce.models.HTMLField')())
