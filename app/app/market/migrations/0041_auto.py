...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field interests on 'MarketItem'
        m2m_table_name = db.shorten_name(u'market_marketitem_interests')
        ...
        db.create_unique(m2m_table_name, ['marketitem_id', 'interest_id'])


    def backwards(self, orm):
        # Removing M2M table for field interests on 'MarketItem'
        db.delete_table(db.shorten_name(u'market_marketitem_interests'))
