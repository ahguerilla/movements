...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MarketItem.staff_owner'
        db.add_column(u'market_marketitem', 'staff_owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='marketitems', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MarketItem.staff_owner'
        db.delete_column(u'market_marketitem', 'staff_owner_id')
