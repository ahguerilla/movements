...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Notification.comment'
        db.add_column(u'market_notification', 'comment',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['market.Comment'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Notification.item'
        db.alter_column(u'market_notification', 'item_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['market.MarketItem'], null=True))

    def backwards(self, orm):
        # Deleting field 'Notification.comment'
        db.delete_column(u'market_notification', 'comment_id')


        # User chose to not deal with backwards NULL issues for 'Notification.item'
        raise RuntimeError("Cannot reverse this migration. 'Notification.item' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Notification.item'
        db.alter_column(u'market_notification', 'item_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['market.MarketItem']))
