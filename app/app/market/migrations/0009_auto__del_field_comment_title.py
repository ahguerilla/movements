...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'market_comment', 'title')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Comment.title'
        raise RuntimeError("Cannot reverse this migration. 'Comment.title' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Comment.title'
        db.add_column(u'market_comment', 'title',
