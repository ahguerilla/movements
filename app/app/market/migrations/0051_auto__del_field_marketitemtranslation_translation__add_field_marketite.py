...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MarketItemTranslation.translation'
        db.delete_column(u'market_marketitemtranslation', 'translation')

        # Adding field 'MarketItemTranslation.title_translated'
        db.add_column(u'market_marketitemtranslation', 'title_translated',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'MarketItemTranslation.details_translated'
        db.add_column(u'market_marketitemtranslation', 'details_translated',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'MarketItemTranslation.translation'
        db.add_column(u'market_marketitemtranslation', 'translation',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Deleting field 'MarketItemTranslation.title_translated'
        db.delete_column(u'market_marketitemtranslation', 'title_translated')

        # Deleting field 'MarketItemTranslation.details_translated'
        db.delete_column(u'market_marketitemtranslation', 'details_translated')
