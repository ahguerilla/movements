...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MarketItem.commentcount'
        db.add_column(u'market_marketitem', 'commentcount',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Comment.published'
        db.add_column(u'market_comment', 'published',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MarketItem.commentcount'
        db.delete_column(u'market_marketitem', 'commentcount')

        # Deleting field 'Comment.published'
        db.delete_column(u'market_comment', 'published')
