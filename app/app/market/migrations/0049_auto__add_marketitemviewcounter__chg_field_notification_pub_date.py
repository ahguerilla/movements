...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MarketItemViewCounter'
        db.create_table(u'market_marketitemviewcounter', (
        ...
        db.send_create_signal('market', ['MarketItemViewCounter'])


        # Changing field 'Notification.pub_date'
        db.alter_column(u'market_notification', 'pub_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):
        # Deleting model 'MarketItemViewCounter'
        db.delete_table(u'market_marketitemviewcounter')


        # Changing field 'Notification.pub_date'
        db.alter_column(u'market_notification', 'pub_date', self.gf('django.db.models.fields.DateTimeField')())
