...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'MarketItemDirectOffer', fields ['market_item']
        db.delete_unique(u'market_marketitemdirectoffer', ['market_item_id'])


        # Changing field 'MarketItemDirectOffer.market_item'
        db.alter_column(u'market_marketitemdirectoffer', 'market_item_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['market.MarketItem']))

    def backwards(self, orm):

        # Changing field 'MarketItemDirectOffer.market_item'
        db.alter_column(u'market_marketitemdirectoffer', 'market_item_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['market.MarketItem'], unique=True))
        # Adding unique constraint on 'MarketItemDirectOffer', fields ['market_item']
        db.create_unique(u'market_marketitemdirectoffer', ['market_item_id'])
