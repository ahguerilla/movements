...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MarketItem.specific_issue'
        db.add_column(u'market_marketitem', 'specific_issue',
    ...
    def backwards(self, orm):
        # Deleting field 'MarketItem.specific_issue'
        db.delete_column(u'market_marketitem', 'specific_issue')
