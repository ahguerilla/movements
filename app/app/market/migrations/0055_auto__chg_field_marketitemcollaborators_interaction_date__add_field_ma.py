...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MarketItemCollaborators.interaction_date'
        db.alter_column(u'market_marketitemcollaborators', 'interaction_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
        # Adding field 'MarketItem.collaboratorcount'
        db.add_column(u'market_marketitem', 'collaboratorcount',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'MarketItemCollaborators.interaction_date'
        db.alter_column(u'market_marketitemcollaborators', 'interaction_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
        # Deleting field 'MarketItem.collaboratorcount'
        db.delete_column(u'market_marketitem', 'collaboratorcount')
