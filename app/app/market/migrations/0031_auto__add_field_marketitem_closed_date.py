...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MarketItem.closed_date'
        db.add_column(u'market_marketitem', 'closed_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MarketItem.closed_date'
        db.delete_column(u'market_marketitem', 'closed_date')
