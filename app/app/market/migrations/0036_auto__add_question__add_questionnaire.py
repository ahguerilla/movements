...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'market_question', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('question', self.gf('django.db.models.fields.TextField')()),
            ('question_type', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('market', ['Question'])

        # Adding model 'Questionnaire'
        db.create_table(u'market_questionnaire', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('market', ['Questionnaire'])

        # Adding M2M table for field questions on 'Questionnaire'
        m2m_table_name = db.shorten_name(u'market_questionnaire_questions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('questionnaire', models.ForeignKey(orm['market.questionnaire'], null=False)),
            ('question', models.ForeignKey(orm['market.question'], null=False))
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'market_question')

        # Deleting model 'Questionnaire'
        db.delete_table(u'market_questionnaire')

        # Removing M2M table for field questions on 'Questionnaire'
        db.delete_table(db.shorten_name(u'market_questionnaire_questions'))
