...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MarketItemImage'
        db.create_table(u'market_marketitemimage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['market.MarketItem'])),
            ('image', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100)),
            ('original', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100)),
            ('original_metadata', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('market', ['MarketItemImage'])


    def backwards(self, orm):
        # Deleting model 'MarketItemImage'
        db.delete_table(u'market_marketitemimage')
