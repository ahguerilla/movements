...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CommentTranslation.reminder'
        db.delete_column(u'market_commenttranslation', 'reminder')
    ...
    def backwards(self, orm):
        # Adding field 'CommentTranslation.reminder'
        db.add_column(u'market_commenttranslation', 'reminder',
