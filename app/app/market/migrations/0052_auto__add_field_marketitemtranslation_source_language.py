...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MarketItemTranslation.source_language'
        db.add_column(u'market_marketitemtranslation', 'source_language',
                      self.gf('django.db.models.fields.CharField')(default='en', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MarketItemTranslation.source_language'
        db.delete_column(u'market_marketitemtranslation', 'source_language')
