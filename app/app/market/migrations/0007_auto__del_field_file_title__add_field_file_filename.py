...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'market_file', 'title')

        # Adding field 'File.filename'
        db.add_column(u'market_file', 'filename',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'File.title'
        raise RuntimeError("Cannot reverse this migration. 'File.title' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'File.title'
        db.add_column(u'market_file', 'title',
                      self.gf('django.db.models.fields.CharField')(max_length=255),
                      keep_default=False)

        # Deleting field 'File.filename'
        db.delete_column(u'market_file', 'filename')
