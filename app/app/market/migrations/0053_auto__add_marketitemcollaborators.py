...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MarketItemCollaborators'
        db.create_table(u'market_marketitemcollaborators', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('market_item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['market.MarketItem'])),
            ('collaborator_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], blank=True)),
            ('interaction_type', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('interaction_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('market', ['MarketItemCollaborators'])


    def backwards(self, orm):
        # Deleting model 'MarketItemCollaborators'
        db.delete_table(u'market_marketitemcollaborators')
    ...
    models = {
        ...
        'market.marketitemcollaborators': {
            ...
            'collaborator_id': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'interaction_date': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
