...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Questionnaire.market_type'
        db.add_column(u'market_questionnaire', 'market_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Questionnaire.market_type'
        db.delete_column(u'market_questionnaire', 'market_type')
    ...
    models = {
        ...
        'market.questionnaire': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'market_type': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200'}),
