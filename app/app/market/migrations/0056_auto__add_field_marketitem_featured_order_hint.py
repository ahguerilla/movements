...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MarketItem.featured_order_hint'
        db.add_column(u'market_marketitem', 'featured_order_hint',
                      self.gf('django.db.models.fields.CharField')(default='c', max_length=5),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MarketItem.featured_order_hint'
        db.delete_column(u'market_marketitem', 'featured_order_hint')
