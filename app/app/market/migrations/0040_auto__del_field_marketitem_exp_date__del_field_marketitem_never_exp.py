...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MarketItem.exp_date'
        db.delete_column(u'market_marketitem', 'exp_date')

        # Deleting field 'MarketItem.never_exp'
        db.delete_column(u'market_marketitem', 'never_exp')


    def backwards(self, orm):
        # Adding field 'MarketItem.exp_date'
        db.add_column(u'market_marketitem', 'exp_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MarketItem.never_exp'
        db.add_column(u'market_marketitem', 'never_exp',
