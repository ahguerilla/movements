...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MarketItemNextSteps'
        db.create_table(u'market_marketitemnextsteps', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('market_item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['market.MarketItem'])),
            ('next_step', self.gf('django.db.models.fields.TextField')()),
            ('date_of_action', self.gf('django.db.models.fields.DateTimeField')()),
            ('completed', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('market', ['MarketItemNextSteps'])


    def backwards(self, orm):
        # Deleting model 'MarketItemNextSteps'
        db.delete_table(u'market_marketitemnextsteps')
    ...
    models = {
        ...
        'market.marketitemactions': {
            ...
            'date_of_action': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
