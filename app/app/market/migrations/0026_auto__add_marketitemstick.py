...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MarketItemStick'
        db.create_table(u'market_marketitemstick', (
        ...
        db.send_create_signal('market', ['MarketItemStick'])


    def backwards(self, orm):
        # Deleting model 'MarketItemStick'
        db.delete_table(u'market_marketitemstick')
