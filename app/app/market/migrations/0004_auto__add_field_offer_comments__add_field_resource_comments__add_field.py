...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'market_offer', 'comments_id')
        ...
        db.delete_column(u'market_resource', 'comments_id')
        ...
        db.delete_column(u'market_request', 'comments_id')
    ...
    models = {
        ...
        u'market.offer': {
            ...
            'comments': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['market.Comment']", 'null': 'True', 'blank': 'True'}),
