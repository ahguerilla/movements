...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MarketNewsItemData.image_field'
        db.add_column(u'market_marketnewsitemdata', 'image_field',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MarketNewsItemData.image_field'
        db.delete_column(u'market_marketnewsitemdata', 'image_field')
