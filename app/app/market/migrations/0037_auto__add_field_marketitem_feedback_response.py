...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MarketItem.feedback_response'
        db.add_column(u'market_marketitem', 'feedback_response',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MarketItem.feedback_response'
        db.delete_column(u'market_marketitem', 'feedback_response')
