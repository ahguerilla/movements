...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Notification.text'
        db.alter_column(u'market_notification', 'text', self.gf('json_field.fields.JSONField')())

    def backwards(self, orm):

        # Changing field 'Notification.text'
        db.alter_column(u'market_notification', 'text', self.gf('django.db.models.fields.CharField')(max_length=500))
