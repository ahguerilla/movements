...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Notification.translation_count'
        db.add_column(u'market_notification', 'translation_count',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Notification.translation_count'
        db.delete_column(u'market_notification', 'translation_count')
