...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ItemRate'
        db.create_table(u'market_itemrate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], blank=True)),
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='rates', null=True, to=orm['market.MarketItem'])),
            ('pub_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('score', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'market', ['ItemRate'])

        # Adding field 'MarketItem.ratecount'
        db.add_column(u'market_marketitem', 'ratecount',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ItemRate'
        db.delete_table(u'market_itemrate')

        # Deleting field 'MarketItem.ratecount'
        db.delete_column(u'market_marketitem', 'ratecount')
