...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MarketNewsItemData'
        db.create_table(u'market_marketnewsitemdata', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('market_item', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['market.MarketItem'], unique=True)),
            ('original_url', self.gf('django.db.models.fields.URLField')(max_length=500)),
            ('last_scraped', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ...
            ('published', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('author_url', self.gf('django.db.models.fields.URLField')(max_length=500, null=True, blank=True)),
            ('author_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal('market', ['MarketNewsItemData'])


    def backwards(self, orm):
        # Deleting model 'MarketNewsItemData'
        db.delete_table(u'market_marketnewsitemdata')
