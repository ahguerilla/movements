...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'market_userreport', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_repots', to=orm['auth.User'])),
        ...
        db.send_create_signal('market', ['UserReport'])


    def backwards(self, orm):
        # Deleting model 'UserReport'
        db.delete_table(u'market_userreport')
