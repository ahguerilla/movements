...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MarketItemHidden'
        db.create_table(u'market_marketitemhidden', (
        ...
        db.send_create_signal('market', ['MarketItemHidden'])


    def backwards(self, orm):
        # Deleting model 'MarketItemHidden'
        db.delete_table(u'market_marketitemhidden')
