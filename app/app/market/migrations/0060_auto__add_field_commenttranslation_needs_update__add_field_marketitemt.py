...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CommentTranslation.needs_update'
        db.add_column(u'market_commenttranslation', 'needs_update',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'MarketItemTranslation.needs_update'
        db.add_column(u'market_marketitemtranslation', 'needs_update',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CommentTranslation.needs_update'
        db.delete_column(u'market_commenttranslation', 'needs_update')

        # Deleting field 'MarketItemTranslation.needs_update'
        db.delete_column(u'market_marketitemtranslation', 'needs_update')
