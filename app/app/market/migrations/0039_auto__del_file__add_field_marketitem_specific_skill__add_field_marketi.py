...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'File'
        db.delete_table(u'market_file')

        # Adding field 'MarketItem.specific_skill'
        db.add_column(u'market_marketitem', 'specific_skill',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)

        # Adding field 'MarketItem.receive_notifications'
        db.add_column(u'market_marketitem', 'receive_notifications',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


        # Changing field 'MarketItem.item_type'
        db.alter_column(u'market_marketitem', 'item_type', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):
        # Adding model 'File'
        db.create_table(u'market_file', (
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(related_name='files', to=orm['market.MarketItem'])),
            ('afile', self.gf('django.db.models.fields.files.FileField')(max_length=100, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('filename', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('market', ['File'])

        # Deleting field 'MarketItem.specific_skill'
        db.delete_column(u'market_marketitem', 'specific_skill')

        # Deleting field 'MarketItem.receive_notifications'
        db.delete_column(u'market_marketitem', 'receive_notifications')


        # Changing field 'MarketItem.item_type'
        db.alter_column(u'market_marketitem', 'item_type', self.gf('django.db.models.fields.CharField')(max_length=200))
