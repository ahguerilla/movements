...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MarketItemCollaborators.collaborator_id'
        db.delete_column(u'market_marketitemcollaborators', 'collaborator_id_id')

        # Adding field 'MarketItemCollaborators.collaborator'
        db.add_column(u'market_marketitemcollaborators', 'collaborator',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'MarketItemCollaborators.collaborator_id'
        db.add_column(u'market_marketitemcollaborators', 'collaborator_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['auth.User'], blank=True),
                      keep_default=False)

        # Deleting field 'MarketItemCollaborators.collaborator'
        db.delete_column(u'market_marketitemcollaborators', 'collaborator_id')
