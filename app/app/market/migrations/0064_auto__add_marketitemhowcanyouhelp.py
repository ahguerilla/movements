...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MarketItemHowCanYouHelp'
        db.create_table(u'market_marketitemhowcanyouhelp', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['market.MarketItem'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('text', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('market', ['MarketItemHowCanYouHelp'])


    def backwards(self, orm):
        # Deleting model 'MarketItemHowCanYouHelp'
        db.delete_table(u'market_marketitemhowcanyouhelp')
