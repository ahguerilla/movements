...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MarketItemTranslation'
        db.create_table(u'market_marketitemtranslation', (
        ...
        db.send_create_signal('market', ['MarketItemTranslation'])


    def backwards(self, orm):
        # Deleting model 'MarketItemTranslation'
        db.delete_table(u'market_marketitemtranslation')
