...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MarketItem.deleted'
        db.add_column(u'market_marketitem', 'deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Comment.deleted'
        db.add_column(u'market_comment', 'deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MarketItem.deleted'
        db.delete_column(u'market_marketitem', 'deleted')

        # Deleting field 'Comment.deleted'
        db.delete_column(u'market_comment', 'deleted')
