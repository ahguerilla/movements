...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MarketItemDirectOffer'
        db.create_table(u'market_marketitemdirectoffer', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('market_item', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['market.MarketItem'], unique=True)),
            ...
            ('specific_interest', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
            ('published', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('pub_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('deleted', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('market', ['MarketItemDirectOffer'])

        # Adding M2M table for field interests on 'MarketItemDirectOffer'
        m2m_table_name = db.shorten_name(u'market_marketitemdirectoffer_interests')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('marketitemdirectoffer', models.ForeignKey(orm['market.marketitemdirectoffer'], null=False)),
            ('interest', models.ForeignKey(orm[u'users.interest'], null=False))
        ))
        db.create_unique(m2m_table_name, ['marketitemdirectoffer_id', 'interest_id'])


    def backwards(self, orm):
        # Deleting model 'MarketItemDirectOffer'
        db.delete_table(u'market_marketitemdirectoffer')

        # Removing M2M table for field interests on 'MarketItemDirectOffer'
        db.delete_table(db.shorten_name(u'market_marketitemdirectoffer_interests'))
