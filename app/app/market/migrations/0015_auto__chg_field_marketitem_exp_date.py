...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MarketItem.exp_date'
        db.alter_column(u'market_marketitem', 'exp_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'MarketItem.exp_date'
        raise RuntimeError("Cannot reverse this migration. 'MarketItem.exp_date' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'MarketItem.exp_date'
        db.alter_column(u'market_marketitem', 'exp_date', self.gf('django.db.models.fields.DateTimeField')())
