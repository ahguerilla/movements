...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MarketItem.specific_skill'
        db.alter_column(u'market_marketitem', 'specific_skill', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'MarketItem.specific_skill'
        db.alter_column(u'market_marketitem', 'specific_skill', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))
    ...
    models = {
        ...
        'market.marketitem': {
            ...
            'specific_skill': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
