...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EmailRecommendation'
        db.create_table(u'market_emailrecommendation', (
            ...
            ('recommendation_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ))
        db.send_create_signal('market', ['EmailRecommendation'])


    def backwards(self, orm):
        # Deleting model 'EmailRecommendation'
        db.delete_table(u'market_emailrecommendation')
