...
market_user_patterns = patterns(
    ...
    url(r'(?P<rtype>\S+)/users/recommend/item/(?P<obj_id>\d+|\S+)$',
    ...
    url(r'users/get/group-names$',
        'app.market.api.views.users.get_group_names',
        name="user_get_group_names"),
)
...
post_translation_patterns = patterns(
    ...
    url(r'^(?P<object_id>\d+)/back-to-edit/$', 'put_back_to_edit', {'model': MarketItemTranslation},
        name="put_back_to_edit"),
...
comment_translation_patterns = patterns(
    ...
    url(r'^(?P<object_id>\d+)/save-draft/$', 'save_draft', {'model': CommentTranslation}, name="save_draft"),
    url(r'^(?P<object_id>\d+)/back-to-edit/$', 'put_back_to_edit', {'model': CommentTranslation},
        name="put_back_to_edit"),
