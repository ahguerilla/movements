...
if settings.PRODUCTION or settings.STAGING:
    ...
    css = Bundle(
        ...
        Bundle(
            './css/site.styl',
            './css/clientside/market_common.styl',
            './css/clientside/market/marketitem.styl',
            './css/clientside/market/actions.styl',
            './css/clientside/market/filter.styl',
            './css/clientside/market/comment.styl',
            './css/clientside/market/navbar.styl',
            './css/clientside/market/postman.styl',
            './css/clientside/market/typeahead_widget.styl',
            './css/site-sm.styl',
            './css/site-xs.styl',
            filters='stylus',
            output ='./css/site.css'
